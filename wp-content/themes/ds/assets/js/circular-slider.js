(function () {
    ...
    Slider.prototype.setSize = function (radius) {
        ...
        this.slidesSize = Math.min(1.5 * radius * this.startSetup.slideSize, this.stepAngle * radius * ( 1 - this.startSetup.slideSize ) - 50);
    ...
    ///////////Init sliders///////////
    window.circularSlider1 = new Slider(document.querySelector('.circular-slider-1'), 100, 15, 600);

    var sliders = [window.circularSlider1];
